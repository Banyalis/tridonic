<template>
    <div class="ContactsPopupSuppliers" :class="{ isHidden }">
        <ContactsPopupForm
            type-form="suppliers"
            :radios="radios"
            :fields="fields"
...
export default {
    ...
    data() {
        return {
            ...
            selects: [
                ...
                {
                    name: TYPES_FIELDS.material,
                    options: [],
                    placeholder: this.$translations.placeholderMaterial(),
                    isRequired: true
                }
            ],
            message: {
    ...
    methods: {
        getOptions(name) {
            ...
            ].concat(this.popupBlack.suppliers[initOptions]);
